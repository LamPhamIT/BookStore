        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <form action="POST" id="form-input">
                    ...
                    <input type="text" name="firstName" id="firstName" value="${editUser.firstName}">

                    <span>Last Name: </span>
                    <input type="text" name="lastName" id="lastName" value="${editUser.lastName}">
                    ...
                    <input type="text" name="phoneNumber" id="phoneNumber" value="${editUser.phoneNumber}">
                    ...
                    <select name="rolee" id="rolee">
                        ...
                        <c:if test="${not empty editUser}">
                            <c:forEach var="i" items="${listRole}">
                                <option value="${i.id}"
                                        <c:if test="${editUser.role.id == i.id}">selected="selected"</c:if> >${i.name}</option>
                            </c:forEach>
                            <option value="">Chọn vai trò</option>
                        </c:if>
                    </select>
