...
<div class="main">
    <div class="container">
        ...
        <form action="<c:url value="/dang-nhap"/>" method="POST" class="signin-form" id="login-form">
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                            <input class="input" id="reEmail" type="text" placeholder="Email..."
                                   class="phone-number-input">
                            <input type="button" class="password-submit" id="getPassword"
                                   value="Lấy lại mật khẩu"></input>
                        </div>
                    </div>
                </div>
...
<script>
    $('#getPassword').on('click', function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                alert('Mật khẩu đã được gửi về email. Vui lòng kiểm trả');
            }
        });
    });
    ...
    function isValidPassword(password) {
        let passwordRegex = /^(?=.*[A-Za-z0-9_])[\w]{8,}$/;
