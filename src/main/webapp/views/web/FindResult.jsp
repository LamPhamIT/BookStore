        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-12 col-sm-12 col-12">
                <form action="<c:url value="/tim-kiem"/>" method="GET" class="search-form" id="search-form">
                    <input type="text" placeholder="Tìm kiếm" name="query" id="query" value="${keyword}">
    ...
    <div class="container">
        ...
        <c:if test="${numberOfProduct != 0}">
            <div class="alert alert-success" role="alert">
                Có ${numberOfProduct} kết quả tìm kiếm với từ khoá "${keyword}"
            </div>
        </c:if>3
        <div class="row">
            <c:forEach var="i" items="${listResult}">
