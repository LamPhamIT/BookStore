        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="account-link">
                    <a href="#">
                        <div class="fas fa-lock"></div>ĐĂNG NHẬP
                    </a>
                    <a href="#">
                        <div class="fas fa-sign-in-alt"></div>ĐĂNG KÝ
                    </a>
                    <a href="#">
                        <div class="fas fa-check-square"></div>THANH TOÁN
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="navbar-items">
                    <div class="row g-0">
                        <ul class="navbar-list">
                            ...
                            <li class="navbar-item hover-item"><a href="#" class="navbar-link">SẢN PHẨM <div
                                    class="fa fa-angle-down"></div></a>
